...
const Slider = () => {
    ...
    const content = [
        {
            image: <img key={slide1} src={slide1} alt="" className={classnames('slider__image', 'img')} />,
            header: <h3 className={classnames('slider__header')}>{t('Slider.1')}</h3>,
            text: <p className={classnames('slider__description')}>{t('Slider.2')}</p>,
            button: <button className={classnames('slider__button', 'slider__button_margin', 'slider__button-parking')}><span>{t('Slider.9')}</span></button>,
        },
        {
            image: <img key={slide2} src={slide2} alt="" className={classnames('slider__image')} />,
            header: <h3 className={classnames('slider__header')}>{t('Slider.3')}</h3>,
            text: <p className={classnames('slider__description')}>{t('Slider.4')}</p>,
            button: <button className={classnames('slider__button', 'slider__button_margin', 'slider__button-insurance')}>{t('Slider.9')}</button>,
        },
        {
            image: <img key={slide3} src={slide3} alt="" className={classnames('slider__image')} />,
            header: <h3 className={classnames('slider__header')}>{t('Slider.5')}</h3>,
            text: <p className={classnames('slider__description')}>{t('Slider.6')}</p>,
            button: <button className={classnames('slider__button', 'slider__button_margin', 'slider__button-petrol')}>{t('Slider.9')}</button>,
        },
        {
            image: <img key={slide4} src={slide4} alt="" className={classnames('slider__image')} />,
            header: <h3 className={classnames('slider__header')}>{t('Slider.7')}</h3>,
            text: <p className={classnames('slider__description')}>{t('Slider.8')}</p>,
            button: <button className={classnames('slider__button', 'slider__button_margin', 'slider__button-service')}>{t('Slider.9')}</button>,
        },
    ];
        ...
        <div className={classnames('slider')}>
            <div className={classnames('slider__slide-circle')}>
                {content.map((content, index) => {
                    return (<div className={classnames("slider__circle",{
                        "slider__circle-active" : activeIndex === index
                    })} key={index} onClick={(e) => handleClickCircle(e, index)}></div>)
                })}
            </div>
            <div className={classnames('slider__turn-over')}>
                <div className={classnames('slider__slide-prev')} onClick={() => handleClickDef()}>
            ...
            <div className={classnames('slider-img', 'slider-img-prev', 'slider-wrapper', 'slider-position-img')}
                key={prevIndex}>
            ...
            <div className={classnames('slider-img', 'wrapper', 'slider-position-img')}
                key={activeIndex} >
                {content[activeIndex].image}
                <div className={
                    classnames('slider__group-description')}>
            ...
            <div className={classnames('slider-img', 'slider-img-next', 'slider-wrapper', 'slider-position-img')}
                key={nextIndex}>
